                ...
                if($num!=0) {
                  if($itiner[$i]->findnodes("*[\@Numero=$j]/PostiDisp")->get_node(1)->textContent() == 0) {
                    ...
                    if (index($luog, $arrivo) != -1) {
                      ...
                      $contenuto = $contenuto."\n
                      <div class=\"risultato\">
                         <a href=\"http://localhost/cgi-bin/tw_progetto_gnrr/file_sito/PERL/assemblatori/assemblatore_singolo_passaggio.cgi?passaggio=$idv&part=$j&arr=$k\"><span class=\"partenza\">$part</span> &#8594; <span class=\"arrivo\">$arr</span></a>
...
sub query_viaggi_utente {
    ...
    for(my $i=0;$i<$num;$i++) {
        ...
        $contenuto = $contenuto."\n
        <div class=\"viaggio\">
        <a href=\"http://localhost/cgi-bin/tw_progetto_gnrr/file_sito/PERL/assemblatori/assemblatore_singolo_passaggio.cgi?passaggio=$idv&part=0&arr=4&prezzo=$prezzo&posti=$posti&cond=$utente\"><span class=\"partenza\">$partenza</span> &#8594; <span class=\"arrivo\">$arrivo</span></a>
        <p>Data: $data</p>
        <p>Ora: $ora</p>
    ...
    for(my $i=0;$i<$num;$i++) {
        ...
        $contenuto = $contenuto."\n
        <div class=\"viaggio\">
        <a href=\"http://localhost/cgi-bin/tw_progetto_gnrr/file_sito/PERL/assemblatori/assemblatore_singolo_passaggio.cgi?passaggio=$idv&part=$num_p&arr=$num_a\"><span class=\"partenza\">$partenza</span> &#8594; <span class=\"arrivo\">$arrivo</span></a>
        <p>Data: $data</p>
        <p>Ora: $ora</p>
        <p>Posti liberi: $posti</p>
        <p>Prezzo: $prezzo</p>
    ...
    if($num==0) {
        ...
        for(my $k=0; $k<$num_pas; $k++) {
            ...
            $contenuto = $contenuto."\n
                <div class=\"viaggio\">
                    <a href=\"http://localhost/cgi-bin/tw_progetto_gnrr/file_sito/PERL/assemblatori/assemblatore_viaggio_recensire.cgi?passaggio=$idv\"><span class=\"partenza\">$partenza</span> &#8594; <span class=\"arrivo\">$arrivo</span><span class=\"data\">$data</span></a>
                </div>
                ";
        }
    }
...
sub query_notifiche_utente {
    ...
    for(my $i=0; $i<$size; $i++) {
        ...
        $contenuto = $contenuto."\n <a href=\"http://localhost/cgi-bin/tw_progetto_gnrr/file_sito/PERL/assemblatori/assemblatore_singola_conversaz.cgi?utente=$mittente\"> Nuovo messaggio privato da $mittente </a>";
    }
    ...
    for(my $i=0; $i<$size; $i++) {
        ...
        if(!$presenza) {
            push @aux, $passaggio;
            $contenuto = $contenuto."\n <a href=\"http://localhost/cgi-bin/tw_progetto_gnrr/file_sito/PERL/assemblatori/assemblatore_viaggio_recensire.cgi?passaggio=$passaggio\"> Passaggio ID:$passaggio da recensire </a>";
        }
    }
    ...
    for(my $i=0; $i<$size; $i++) {
        ...
        $contenuto = $contenuto."\n
            <form action=\"http://localhost/cgi-bin/tw_progetto_gnrr/file_sito/PERL/ricevitori/ricevitore_esito_prenotazione.cgi\" method=\"post\" >
                <fieldset>
